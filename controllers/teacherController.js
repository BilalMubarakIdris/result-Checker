...
const teacher_add_post = async (req, res) => {
    const singleStudent = new Student({
        ...
        roll : req.body.roll,
        dob : req.body.dob,
        com113 : req.body.com113,
        stat111 : req.body.stat111,
        com112 : req.body.com112,
        comm_skills : req.body.comm_skills,
        intro_computer : req.body.intro_computer,
        citizen_edu: req.body.citizen_edu,
        elemt_prob: req.body.elemt_prob,
